...
The UI fixture models 24 project records across those six record types, nine
direct impacts, and seven downstream impacts. Its counts are derived from the
typed fixture rather than duplicated as independent backend data.
