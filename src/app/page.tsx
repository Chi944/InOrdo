        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <p className="mt-1 text-sm leading-6 text-muted" id="demo-status-note">
              The workspace uses a typed local fixture. Model extraction,
              persistence, approvals, operations, undo, and production reset
              are not connected.
            </p>
          </div>

          <a
            className="mt-6 inline-flex min-h-12 items-center gap-2 bg-ink px-5 text-sm font-semibold text-white no-underline transition-colors hover:bg-signal focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-signal"
            href="/demo"
